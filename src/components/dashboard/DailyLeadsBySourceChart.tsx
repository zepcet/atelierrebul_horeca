...
import { CHART_ADS, CHART_WEBSITE } from "@/lib/brand-colors";
      ...
      <CardContent className="pt-0">
        <ResponsiveContainer width="100%" height={240}>
          <BarChart data={chartData} margin={{ left: 0, right: 10, top: 10, bottom: 0 }}>
            ...
            />
            <Bar dataKey="ads" name="Ads Leads" fill={CHART_ADS} stroke="none" strokeWidth={0} radius={[4, 4, 0, 0]} barSize={20} stackId="stack" />
            <Bar dataKey="website" name="Website Leads" fill={CHART_WEBSITE} stroke="none" strokeWidth={0} radius={[4, 4, 0, 0]} barSize={20} stackId="stack" />
          </BarChart>
        </ResponsiveContainer>
      </CardContent>
    </Card>
