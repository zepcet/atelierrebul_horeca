...
const PRIORITY_FILTERS: { value: number; label: string; emoji: string; bg: string; activeBg: string }[] = [
  { value: 1, label: "P1", emoji: "🟢", bg: "border-border text-muted-foreground hover:border-emerald-400/50", activeBg: "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 border-emerald-400" },
  { value: 2, label: "P2", emoji: "🟡", bg: "border-border text-muted-foreground hover:border-amber-400/50", activeBg: "bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 border-amber-400" },
  { value: 3, label: "P3", emoji: "🔵", bg: "border-border text-muted-foreground hover:border-blue-400/50", activeBg: "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 border-blue-400" },
