...
const Login = () => {
  const [email, setEmail] = useState(() => import.meta.env.VITE_PREFILL_LOGIN_EMAIL ?? "");
      ...
      <Card className="w-full max-w-sm sm:max-w-md border border-border bg-card mx-2">
        <CardContent className="p-6 sm:p-8">
          <div className="flex flex-col items-center mb-8">
            <img src={logo} alt="Reflect Studio Merch" className="h-7 sm:h-8 mb-4 max-w-[min(100%,280px)] object-contain object-left brightness-0" />
