  ...
  return (
    <div className="p-3 md:p-4 flex flex-col h-[calc(100vh-3.5rem)]">
      <div className="flex items-center gap-2 mb-3">
        <Mail className="h-4 w-4 text-heyday-midnight" />
        <h2 className="text-sm font-semibold text-foreground">Lead Hub — P3 & P4</h2>
        <span className="text-[10px] px-2 py-0.5 rounded-full bg-heyday-mint/35 text-heyday-charcoal border border-heyday-charcoal/30 font-medium">
          💬 WA + Mail
        </span>
